...
const Agenda = () => {
  ...
  const [dateEvent, setDateEvent] = useState(
    moment('0470-11-20').format('YYYY-MM-DD')
  );
  ...
  const conveneKnights = () => {
    ...
    axios
      .post('https://kaamelot-server.herokuapp.com/agenda', {
        title: title,
        start: dateEvent,
      })
    ...
    <>
      <div className='agendaSection'>
        ...
        <form>
          ...
          <input
            type='text'
            value={knightAssignedEvent}
            placeholder='Knights...'
            onChange={(e) => setKnightAssignedEvent(e.target.value)}
          />
          <input
          ...
          <textarea
            value={commEvent}
            placeholder='Comment...'
            onChange={(e) => setCommEvent(e.target.value)}
          />
